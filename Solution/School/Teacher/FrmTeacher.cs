...
namespace School.Teacher
{
    public partial class FrmTeacher : Form
    {
        ...
        public FrmTeacher(Guid? id = null, bool canEdit = true)
        {
            InitializeComponent();
            ...
            {
                companyID = (Guid)id;
                string query = string.Format("SELECT * FROM tbTeacher WHERE ID='{0}'", id);
        ...
        private bool Save()
        {
            if (Helpers.CheckEmpty(errorProvider1, txtNameInKhmer,
                txtPhone))
            {
                return false;
            }
        ...
        private void ClearData()
        {
            ...
            txtPhone.Text = txtNameInKhmer.Text = null;
        }
